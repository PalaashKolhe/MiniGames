    ...
    if turn == 'human':
        if ship[0][0] == ship[1][0]:
            if int(ship[0][1]) > (11 - length):
                ship = input("There are not enough spots available to fit the ship! Enter different co-ordinates: ")
...
batship2 = chkSpot(chkSpaces([carrier2[0], '-',  carrier2[2]], 4, 'ai'), 4, 'ai')
